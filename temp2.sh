...
echo "Menu"
echo "1. File name (with extension)"
echo "2. Directory name"
echo "3. Greater than (file size, bytes)"
echo "4. Less than (file size, bytes)"
echo "5. Content"
echo "6. Run search"
echo "7. Quit"
...
case "$userInput" in
		...
		6|"6.")
		searchQuery=$(find $directoryNameQuery -type f $fileNameQuery $fileSizeGreaterThanQuery $fileSizeLessThanQuery $fileContentQuery)
